...
function vw_car_rental_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'vw_car_rental_panel_id', array(
	    'priority' => 10,
	    'capability' => 'edit_theme_options',
	    'theme_supports' => '',
	    'title' => __( 'VW Settings', 'vw-car-rental' ),
	    'description' => __( 'Description of what this panel does.', 'vw-car-rental' ),
	) );
	...
	//Blog Post
	$wp_customize->add_section('vw_car_rental_blog_post',array(
    ...
    $wp_customize->add_control( new VW_Car_Rental_Toggle_Switch_Custom_Control( $wp_customize, 'vw_car_rental_toggle_postdate',array(
        ...
        'section' => 'vw_car_rental_blog_post'
    )));

		...
		<div class="col-lg-1 col-md-2">
			<div class="search-box">
				<a href="#" onclick="search_open()" ><i class="fas fa-search"></i>
		     		<span class="screen-reader-text"><?php esc_html_e( 'Search','sayara-automotive' );?></span>
		     	</a>
		    </div>
		</div>
	</div>
	<div class="serach_outer">
	    <a href="#" onclick="search_close()" class="closepop">X<span class="screen-reader-text"><?php esc_html_e( 'serach-outer','sayara-automotive' );?></span></a>
